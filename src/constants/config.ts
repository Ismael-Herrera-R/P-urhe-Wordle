export const CONFIG = {
  ...
  wordListSource: 'Ju je uantani', // Describe the source material for your words here
  ...
  defaultLang: 'tsz', // the default interface language
  availableLangs: ['ay', 'es','en', 'tsz'], // the options available to the user for translation languages
